...
import org.jhotdraw.app.persistence.PersistenceHandler;
...
import static org.jhotdraw.app.Application.ACTIVE_VIEW_PROPERTY;
...
public abstract class AbstractApplication extends AbstractBean implements Application
{
	...
	public void start()
	{
		...
		//GJ Drawing Persistence. Load Persistence after the canvas has been setup.
		new PersistenceHandler((SVGView) p);
